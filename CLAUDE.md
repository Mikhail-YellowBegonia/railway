...
——**✅ 设计已研讨完毕、规划已封口（2026-09-10）**；**P0（分段器）/ P1（计划数据类型）/ P2（锚点解析器）/ P3a（冻结路径）已落地，
下一步 = P4（拓扑变更防火墙）→ P3b（计划机制接入列车——第一个"有行为"的阶段）**。
...
- **demo 要做（最大缺口）**：**计划式自动驾驶**——创建计划并跟随计划。现状是
  ...
  「计划层定案」；**实施路线 = `docs/plan_layer_roadmap.md`（P0~P9）——P0~P3a 已完成，下一步 P4**；
